...
public class MainDOM {
    public static void main(String[] args) {
        ...
        buscarCorredorPorCodigo(gestor);
    ...
    private static void crearYGuardarCorredor(GestorCorredores gestor) {
    ...
    private static void buscarCorredorPorDorsal(GestorCorredores gestor) {
        System.out.println("------------------\nMOSTRAR CORREDOR SEGÚN DORSAL");
        Corredor corredorBuscarDorsal = gestor.getCorredor(2);
        corredorBuscarDorsal.mostrarInformacion();
    }

    private static void buscarCorredorPorCodigo(GestorCorredores gestor) {
